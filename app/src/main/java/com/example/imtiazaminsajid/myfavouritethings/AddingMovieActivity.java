...
public class AddingMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adding_movie);
    ...
    public void addMovie(View view) {
        ...
        if(name.isEmpty()){
            ...
            if (rowIdED>0){
                ...
                if (status){
                    startActivity(new Intent(AddingMovieActivity.this, MovieListActiveity.class));
                }else {
